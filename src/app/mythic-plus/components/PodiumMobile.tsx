...
export default function PodiumMobile({ members }: { members: MemberType[] }) {
  ...
  return (
    <div className="relative bg-[url('../public/podium.webp')] bg-contain bg-no-repeat h-56 block md:hidden w-[20rem] md:basis-2/6">
      <div
